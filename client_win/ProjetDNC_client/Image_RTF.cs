...
{
    public  class Image_RTF
    {
        Main_form mf;

        public Image_RTF(Main_form form)
        {
            mf = form;
        }
        ...
        private  void embedImage(Image img)
        {
            ...
            rtf.Append(GetFontTable(mf.chat_window.Font));
            ...
            rtf.Append(@"}");
            mf.chat_window.SelectedRtf = rtf.ToString();
        }
        ...
        private string GetImagePrefix(Image _image)
        {
            float xDpi, yDpi;
            var rtf = new StringBuilder();
            using (Graphics graphics = mf.chat_window.CreateGraphics())
            {
                xDpi = graphics.DpiX;
                yDpi = graphics.DpiY;
            }
        ...
        private string getRtfImage(Image image)
        {
            ...
            try
            {
                ...
                using (graphics = mf.chat_window.CreateGraphics())
                {
